...
5. Create a new Custom Field and assign it to Items of Class HVAC, subclass Manifold. Create another, that is applicable to all classes. Add it to Design Subtotals and verify that it is visible in the Item Details page. While there check that the filter on the left and the Identify button is working for HVAC/Manifold
